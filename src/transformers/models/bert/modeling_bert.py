...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        custom_attn: Optional[torch.Tensor] = None,
    ) -> Tuple[torch.Tensor]:
...
class BertSdpaSelfAttention(BertSelfAttention):
    ...
    def scaled_dot_product_attention(self, query, key, value, attn_mask=None, custom_attn=None, dropout_p=0.0, is_causal=False, scale=None) -> torch.Tensor:
